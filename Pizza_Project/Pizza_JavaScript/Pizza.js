...
function getTopping(runningTotal, text1) {
    ...
    getVegetable(runningTotal, toppingTotal, text1);
};
   
function getVegetable(runningTotal, toppingTotal, text1) {
    ...
    console.log(vegetableCount+" vegetable = "+"$"+vegetableTotal+".00");
